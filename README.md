...
CAS module dependencies are typically defined beforehand inside
the `dependencies {}` block in the `build.gradle` file towards the end:

```groovy
implementation "org.apereo.cas:cas-server-support-xyz"
```
